...
CREATE UNIQUE INDEX IF NOT EXISTS idx_retrieval_traces_assistant_message
    ON retrieval_traces(assistant_message_id);
...
CREATE INDEX IF NOT EXISTS idx_retrieval_traces_thread_created
    ON retrieval_traces(thread_id, created_at);
