...
def get_graph_assist_config() -> dict[str, object]:
    """Read user-controlled Graph Assist settings. Defaults keep UI opt-in disabled."""
    return {
        "user_toggle_enabled": _env_bool("CODESEEK_GRAPH_ASSIST_USER_TOGGLE", False),
    }
